...
#    disable gk ability to get ball easily so that we can play the trick get rid of goalkeeper
#    params['lambda_gk'] = params['lambda_def']
...
def generate_pitch_control_for_event(event_id, events, tracking_home, tracking_away, params, GK_numbers, field_dimen = (105.,68.,), n_grid_cells_x = 50, offsides=False):
