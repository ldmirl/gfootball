...
def get_EPV_at_location(x,y, EPV, attack_direction, field_dimen=(105., 68.)):
    """ get_EPV_at_location
...
def calculate_epv_added(x,y,attack_direction,event_id, events, tracking_home, tracking_away, GK_numbers, EPV, params):
    """ calculate_epv_added
    ...
    EPV_target = get_EPV_at_location(x,y, EPV, attack_direction=attack_direction)
...
def find_max_value_added_target(event_id, events, tracking_home, tracking_away, GK_numbers, EPV, params):
    ...
    Patt_start, _ = mpc.calculate_pitch_control_at_target(pass_start_pos, attacking_players, defending_players,
    ...
    PPCF, xgrid, ygrid = mpc.generate_pitch_control_for_event(event_id, events, tracking_home, tracking_away, params,
                                                              GK_numbers, field_dimen=(105., 68.,), n_grid_cells_x=50,
                                                              offsides=True)
