# -*- coding: utf-8 -*-
"""
Created on Fri May 14 14:59:29 2021
pit
@author: AaronGu
"""
...
'''
def plot_frame(hometeam, awayteam, figax=None, team_colors=('r', 'b'), field_dimen=(105.0, 68.0),
...
def save_match_clip(hometeam, awayteam, fpath, fname='clip_test', figax=None, frames_per_second=25,
                    team_colors=('r', 'b'), field_dimen=(105.0, 68.0), include_player_velocities=False,
...
def plot_events(events, figax=None, field_dimen=(105.0, 68.0), indicators=['Marker', 'Arrow'], color='r',
...
def plot_pitchcontrol_for_event(timestep, event_id, events, tracking_home, tracking_away, PPCF, alpha=0.7,
    ...
    if pass_team == 'Home':
        ...
        # plot_frame( tracking_away.loc[pass_frame], tracking_home.loc[pass_frame], figax=(fig,ax), PlayerAlpha=alpha, include_player_velocities=include_player_velocities, annotate=annotate )
        cmap = 'bwr'
    ...
    # path = '/home/aaron/Desktop/pitchcontrol.png'
    ...
    # cv2.imwrite('/home/aarongu/Desktop/pitchcontrol_new.png', img_show)
    # plt.close(fig)
    return img